...
SECRET_KEY = 'django-insecure-nd819zzhdt=0pxz6kp8&ko3owk=m$)!7jdv2-zbs^zv%uj8ntt'
...
SIMPLE_JWT = {
    ...
    'SIGNING_KEY': "d!=d9-t#vxjc(*9rd(a%-j)sv=+u^n=*g7sotbhn7(0rywxn6t",
    'VERIFYING_KEY': None,
    'ALGORITHM': 'HS256',
    'AUDIENCE': None,
    'ISSUER': None,
...
SENDER_GRID_API_KEY = os.getenv('APIKEY')
